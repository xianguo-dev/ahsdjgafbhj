...
python tools/data/build_file_list.py ${DATASET} ${SRC_FOLDER} [--rgb-prefix ${RGB_PREFIX}] \
    ...
    python tools/data/build_file_list.py ucf101 /home/xianguo/framesoutput/TSNInput/出门  --level 1 --format rawframes --out-root-path /home/xianguo/mmaction2-master/data/ 
